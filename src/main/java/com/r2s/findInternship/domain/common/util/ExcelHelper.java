...
public class ExcelHelper {
    ...
    static String[] HEADERs = {"STT", "Tên công việc", "Vị trí", "Chuyên ngành", "Hình thức công việc",
            "Trợ cấp tối thiểu", "Trợ cấp tối đa", "Địa chỉ", "Tỉnh/TP", "Mô tả công việc", "Yêu cầu công vệc",
            "Chế độ phúc lợi", "Ngày đăng tuyển", "Hạn nộp"};
                ...
                while (cellsInRow.hasNext() && !flage) {
                    ...
                    switch (cellIdx) {
                        ...
                        case 2:
                            ...
                            List<String> listStrJobPoss = Stream.of(joPoss.split(";")).toList();
                        ...
                        case 3:
                            ...
                            // slip string to list string by ";"
                            List<String> listStrMajor = Stream.of(majorStr.split(";")).toList();
                        ...
                        case 4:
                            ...
                            // slip string to list string by ";"
                            List<String> listStrJobtype = Stream.of(jobTypeStr.split(";")).toList();
                        ...
                        case 6:
                            job.setMinAllowance((double) currentCell.getNumericCellValue());
                            break;

                        case 7:
                            job.setMaxAllowance((double) currentCell.getNumericCellValue());
                            break;
                        ...
                        case 9:
                            job.setCity(currentCell.getStringCellValue());
                            break;

                        case 10:
                            job.setDistrict(currentCell.getStringCellValue());
                            break;
                        ...
                        case 13:
                            job.setRequirements(currentCell.getStringCellValue());
                            break;
                        ...
                        case 15:
                            ...
                            if (dateStart == null)
                                ...
                                job.setPostingDate(startdate);
                            }
                            break;

                        case 16:
                            LocalDateTime dateEnd = currentCell.getLocalDateTimeCellValue();
                            job.setApplicationDeadline(java.sql.Timestamp.valueOf(dateEnd));
                            break;
